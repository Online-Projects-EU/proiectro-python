...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/{tenant_path}/partner_portal/{bridge_id}/support/{support_request_id}/generate_upload_url".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Partner Portal Generate Upload Url

     Generate upload URL for partner portal support request files.
