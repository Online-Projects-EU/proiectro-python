...
from ...models.edit_partner_support_request import EditPartnerSupportRequest
...
def _get_kwargs(
    ...
    *,
    body: EditPartnerSupportRequest,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/api/v1/{tenant_path}/partner_portal/edit_support_request/{support_request_id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Partner Portal Edit Support Request
    ...
    Args:
        tenant_path (str):
        support_request_id (str):
        body (EditPartnerSupportRequest): Input schema for partner editing support request
