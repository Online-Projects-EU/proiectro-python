...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/{tenant_path}/partner_portal/{bridge_id}/support_requests".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Partner Portal Support Requests

     Get support requests between partners visible through bridge.
