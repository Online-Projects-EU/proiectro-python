...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/{tenant_path}/project_team_member_work_items/{project_id}/{member_id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Project Team Member Work Items

     List all work items owned by a specific team member in a project.
    Shows flat list of work items with hierarchy IDs, types, and status.
    Useful for team member workload views and individual assignment tracking.
