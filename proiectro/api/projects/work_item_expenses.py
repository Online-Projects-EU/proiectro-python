...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/{tenant_path}/work_item_expenses/{work_item_id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Work Item Expenses
     ...
     List all actual expenses for a work item.
    Shows real spending for budget tracking and variance analysis.
