...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/{tenant_path}/generate_upload_url_resource/{resource_id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Generate Upload Url Resource
     ...
     Attach documentation to resources like equipment, facilities, or tools. Upload
    manuals, maintenance records, certifications, and usage guidelines. Centralize
    resource information for easy team access and compliance tracking.
