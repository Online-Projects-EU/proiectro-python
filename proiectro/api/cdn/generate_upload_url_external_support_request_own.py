...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/{tenant_path}/generate_upload_url_external_support_request_own/{support_request_id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Generate Upload Url External Support Request Own

     Upload files to your own external support tickets from customer portal without
    full support permissions. Add clarifying documents, updated screenshots, or
    additional context to help resolve your issue faster. Limited to tickets you created.
