...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/{tenant_path}/generate_upload_url_internal_support_request_own/{support_request_id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Generate Upload Url Internal Support Request Own

     Upload files to your own support tickets without full support permissions.
    Add clarifying documents, updated screenshots, or additional context to help
    resolve your issue faster. Limited to tickets you created.
