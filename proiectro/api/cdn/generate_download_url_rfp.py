...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/{tenant_path}/generate_download_url_rfp/{rfp_id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Generate Download Url Rfp

     Download files attached to an RFP. Access specifications, requirements, and
    supporting documents. The secure URL expires after 1 minute for security.
