...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/{tenant_path}/generate_upload_url_project_work_item/{work_item_id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Generate Upload Url Project Work Item

     Attach documents, specifications, and deliverables to project work items. Upload
    design files, test results, progress reports, and technical documentation.
    Files become part of the project record for tracking and compliance.
