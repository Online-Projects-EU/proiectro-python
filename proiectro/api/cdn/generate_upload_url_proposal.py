...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/{tenant_path}/generate_upload_url_proposal/{proposal_id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Generate Upload Url Proposal

     Attach supporting documents to project proposals. Upload specifications, designs,
    budgets, and reference materials. All files become part of the project record.
    Organize documentation to support decision-making and project execution.
