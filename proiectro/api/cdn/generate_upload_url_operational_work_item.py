...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/{tenant_path}/generate_upload_url_operational_work_item/{work_item_id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Generate Upload Url Operational Work Item

     Upload documents for operational work items including procedures, checklists,
    and compliance records. Attach standard operating procedures, maintenance logs,
    and regulatory documentation for ongoing operational activities.
