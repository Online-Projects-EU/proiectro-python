...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/{tenant_path}/generate_upload_url_org/{org_id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Generate Upload Url Org

     Upload documents and files specific to customer organizations. Store contracts,
    agreements, and customer-specific resources. Files are isolated per organization
    for data security. The 15-minute upload window ensures secure, controlled access.
