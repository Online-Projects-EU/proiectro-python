...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/{tenant_path}/generate_upload_url_internal_support_request/{support_request_id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Generate Upload Url Internal Support Request

     Attach screenshots, logs, or documents to internal support tickets. Provide
    context for faster issue resolution. Support staff can access all attachments
    to understand and resolve problems efficiently.
