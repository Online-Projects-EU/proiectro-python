...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/{tenant_path}/list_saved_filters_my_closed_support_requests".format(
...
def sync_detailed(
    ...
    *,
    ...
    """List Saved Filters My Closed Support Requests

     Retrieve all saved filters for your closed internal support requests.
