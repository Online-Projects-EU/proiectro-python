...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/{tenant_path}/list_saved_filters_queue_closed_internal_support_requests/{queue_id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """List Saved Filters Queue Closed Internal Support Requests

     List all available saved filters for a specific internal closed support request queue. Returns
    filters
