...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/{tenant_path}/list_saved_filters_assigned_external_support_requests".format(
...
def sync_detailed(
    ...
    *,
    ...
    """List Saved Filters Assigned External Support Requests

     Retrieve all saved filters for assigned external support requests.
