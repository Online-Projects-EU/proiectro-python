...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/{tenant_path}/customerportal_projects/{org_id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Customerportal Projects

     Customer portal view of active projects with payment aggregations.
    List group of projects and aggregated payment dates/sums for customer organization.
