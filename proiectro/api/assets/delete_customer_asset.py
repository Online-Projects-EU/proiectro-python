...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": "/api/v1/{tenant_path}/delete_customer_asset/{asset_id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Delete Customer Asset
     ...
     Delete a customer asset with options for handling children.
    Children can be deleted or reparented to another asset belonging to the same customer.
    If the asset has no children, it is deleted directly.
