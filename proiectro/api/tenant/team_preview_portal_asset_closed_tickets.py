...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/{tenant_path}/portal/{customer_org_external_id}/asset_closed_tickets/{asset_id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Team Preview Portal Asset Closed Tickets

     Preview customer portal closed asset tickets as team member.
    Returns closed ESRs linked to a specific asset of a customer organization.
