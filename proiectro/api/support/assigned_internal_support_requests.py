...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/{tenant_path}/assigned_internal_support_requests".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Assigned Internal Support Requests

     Access internal team requests requiring your expertise or action.
    Shows requests across all queues assigned specifically to you.
    Focus on resolution to maintain team productivity. Update status
    regularly to keep requesters informed of progress.
