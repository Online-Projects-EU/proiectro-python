...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/{tenant_path}/queue_closed_external_support_requests/{queue_id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Queue Closed External Support Requests

     Analyze resolved customer issues for service improvement opportunities.
    Review customer satisfaction with resolutions. Identify recurring
    problems requiring product fixes or documentation. Build knowledge
    base from successful resolutions.
