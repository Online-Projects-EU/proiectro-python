...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/{tenant_path}/internal_support_request/{support_request_id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Internal Support Request
     ...
     View complete request details including description, status, and assignment.
    Shows full context for support agents to understand and resolve issues.
