...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/{tenant_path}/my_closed_support_requests".format(
...
def sync_detailed(
    ...
    *,
    ...
    """My Closed Support Requests

     Access your resolved support request history for reference and patterns.
    Review solutions for similar future issues. Closed requests can be
    reopened within configured time windows if problems recur.
    Useful for tracking recurring issues or solution effectiveness.
