...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/{tenant_path}/queue_external_support_requests/{queue_id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Queue External Support Requests

     Monitor customer tickets in specific support queue for SLA compliance.
    External requests require timely response to maintain satisfaction.
    Track aging tickets and prioritize based on customer impact.
    Critical for maintaining service level commitments.
