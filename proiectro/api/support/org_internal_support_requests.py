...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/{tenant_path}/org_internal_support_requests/{org_id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Org Internal Support Requests

     View all open internal support requests related to a specific customer organization.
    Understand customer pain points and recurring issues. Essential for
