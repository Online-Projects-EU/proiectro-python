...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/{tenant_path}/org_external_support_requests/{org_id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Org External Support Requests

     View all open external support requests from a specific customer organization.
