...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/{tenant_path}/assigned_external_support_requests".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Assigned External Support Requests

     View customer support tickets assigned to you for resolution.
    External requests require customer communication and SLA compliance.
    Prioritize based on severity and customer tier. Track time to ensure
    response commitments are met.
