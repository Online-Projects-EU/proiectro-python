...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/{tenant_path}/queue_closed_internal_support_requests/{queue_id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Queue Closed Internal Support Requests

     Review resolved requests for quality assurance and knowledge building.
    Analyze resolution patterns and success rates. Useful for training
    new team members and identifying process improvements. Historical
    data helps predict future queue performance.
