...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/{tenant_path}/work_item_closed_external_support_requests/{work_item_id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Work Item Closed External Support Requests

     Access resolved external support request history for a work item.
    Review customer issues that were addressed during work item execution.
