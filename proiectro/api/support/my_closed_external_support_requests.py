...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/{tenant_path}/my_closed_external_support_requests".format(
...
def sync_detailed(
    ...
    *,
    ...
    """My Closed External Support Requests

     Access your resolved external support request history and solutions.
    Review past customer issues, analyze resolution patterns, and reference
    solutions for similar future cases. Closed tickets can be reopened
    within configured windows if issues resurface.
