...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/{tenant_path}/my_support_requests".format(
...
def sync_detailed(
    ...
    *,
    ...
    """My Support Requests
     ...
     View your submitted support requests currently being processed.
    Track progress, add comments, and receive resolution updates.
    Shows requests across all queues and assignees for complete visibility.
    Essential for following up on pending issues affecting your work.
