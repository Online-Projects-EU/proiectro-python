...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/{tenant_path}/assigned_closed_internal_support_requests".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Assigned Closed Internal Support Requests

     Access your completed internal support work for reference and metrics.
    Review resolution approaches for similar future requests. Track
    personal productivity and expertise development. Builds knowledge
