...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/{tenant_path}/my_external_support_requests".format(
...
def sync_detailed(
    ...
    *,
    ...
    """My External Support Requests

     View your submitted external support requests currently being processed.
    Track customer-facing tickets, monitor resolutions, and manage escalations.
    Shows all external tickets you've created across queues and teams.
    Essential for coordinating customer support and tracking issue status.
