...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/{tenant_path}/assigned_closed_external_support_requests".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Assigned Closed External Support Requests

     Review your resolved customer tickets for performance evaluation.
    Track personal resolution metrics and customer satisfaction scores.
    Learn from past successes and challenges. Useful for identifying
    personal expertise areas and improvement opportunities.
