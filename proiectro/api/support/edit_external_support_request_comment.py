...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/api/v1/{tenant_path}/edit_external_support_request_comment/{comment_id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Edit External Support Request Comment

     Edit an external support request comment (admin).
