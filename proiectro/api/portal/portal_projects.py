...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/portal/{customer_org_id}/projects".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Portal Projects
     ...
     Get active projects for customer organization.
    Returns project details with payment aggregations and next payment dates.
