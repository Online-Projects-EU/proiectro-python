...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/portal/{customer_org_id}/closed_support_requests".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Portal Closed Support Requests

     Get closed support requests for customer organization.
    Returns closed support requests with resolution status.
