...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/portal/{customer_org_id}/asset_tickets/{asset_id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Portal Asset Tickets

     Get support requests linked to an asset (reported_asset only).
    Returns ESRs where this asset was reported as the issue source.
