...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/portal/{customer_org_id}/support_requests/{support_request_id}/generate_download_url".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Portal Generate Download Url

     Generate signed download URL for accessing support request files.
    Org-level access: any team member from customer org can download files.
