...
T = TypeVar("T", bound="AddWorkItemExpense")


@_attrs_define
class AddWorkItemExpense:
    """
    Attributes:
        work_item (str):
        actual_amount (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        add_work_item_expense.additional_properties = d
        return add_work_item_expense
