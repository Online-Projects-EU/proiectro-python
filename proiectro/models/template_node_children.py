...
T = TypeVar("T", bound="TemplateNodeChildren")


@_attrs_define
class TemplateNodeChildren:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        template_node_children.additional_properties = additional_properties
        return template_node_children
