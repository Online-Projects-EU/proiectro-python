...
T = TypeVar("T", bound="MyInternalSupportRequestFilterSchema")


@_attrs_define
class MyInternalSupportRequestFilterSchema:
    """Filter schema for 'My Internal Support Requests' page.

    Allows users to filter their own submitted internal support requests.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        my_internal_support_request_filter_schema = cls(
        ...
        my_internal_support_request_filter_schema.additional_properties = d
        return my_internal_support_request_filter_schema
