...
T = TypeVar("T", bound="EditAssetCategory")


@_attrs_define
class EditAssetCategory:
    """
    Attributes:
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        edit_asset_category.additional_properties = d
        return edit_asset_category
