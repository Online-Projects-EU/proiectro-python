...
T = TypeVar("T", bound="EditCustomerLocation")


@_attrs_define
class EditCustomerLocation:
    """
    Attributes:
        location (str):
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        edit_customer_location.additional_properties = d
        return edit_customer_location
