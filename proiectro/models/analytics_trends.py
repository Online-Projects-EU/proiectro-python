...
if TYPE_CHECKING:
    from ..models.analytics_trend_item import AnalyticsTrendItem
    from ..models.compare_option import CompareOption
    from ..models.horizon_option import HorizonOption


T = TypeVar("T", bound="AnalyticsTrends")


@_attrs_define
class AnalyticsTrends:
    """Business trends for Command Center
    ...
    Attributes:
        ...
        trends (list[AnalyticsTrendItem] | Unset):
    """
    ...
    trends: list[AnalyticsTrendItem] | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        trends: list[dict[str, Any]] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        trends: list[AnalyticsTrendItem] | Unset = UNSET
        if _trends is not UNSET:
            trends = []
            for trends_item_data in _trends:
                trends_item = AnalyticsTrendItem.from_dict(trends_item_data)

                trends.append(trends_item)

        analytics_trends = cls(
            period=period,
        ...
        analytics_trends.additional_properties = d
