...
T = TypeVar("T", bound="SubtenantLegalInfo")


@_attrs_define
class SubtenantLegalInfo:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        subtenant_legal_info.additional_properties = d
        return subtenant_legal_info
