...
T = TypeVar("T", bound="AssignedExternalSupportRequestFilterSchema")


@_attrs_define
class AssignedExternalSupportRequestFilterSchema:
    """Filter schema for 'Assigned To Me - External Support Requests' page.

    Allows users to filter external support requests assigned to them.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        assigned_external_support_request_filter_schema = cls(
        ...
        assigned_external_support_request_filter_schema.additional_properties = d
        return assigned_external_support_request_filter_schema
