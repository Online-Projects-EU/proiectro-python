...
T = TypeVar("T", bound="EditWorkItemExpense")


@_attrs_define
class EditWorkItemExpense:
    """
    Attributes:
        actual_amount (str):
        actual_date (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        actual_amount = d.pop("actual_amount")

        actual_date = d.pop("actual_date")
        ...
        edit_work_item_expense.additional_properties = d
        return edit_work_item_expense
