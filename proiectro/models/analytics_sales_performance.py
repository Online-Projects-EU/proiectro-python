...
if TYPE_CHECKING:
    from ..models.analytics_performance_entry import AnalyticsPerformanceEntry
    from ..models.compare_option import CompareOption
    from ..models.horizon_option import HorizonOption


T = TypeVar("T", bound="AnalyticsSalesPerformance")


@_attrs_define
class AnalyticsSalesPerformance:
    """Sales performance across three dimensions: salespeople, customers, products
    ...
    Attributes:
        ...
        revenue_change_pct (float | None | str | Unset):
        salespeople (list[AnalyticsPerformanceEntry] | Unset):
        customers (list[AnalyticsPerformanceEntry] | Unset):
        products (list[AnalyticsPerformanceEntry] | Unset):
    """
    ...
    revenue_change_pct: float | None | str | Unset = UNSET
    salespeople: list[AnalyticsPerformanceEntry] | Unset = UNSET
    customers: list[AnalyticsPerformanceEntry] | Unset = UNSET
    products: list[AnalyticsPerformanceEntry] | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        salespeople: list[dict[str, Any]] | Unset = UNSET
        if not isinstance(self.salespeople, Unset):
            salespeople = []
            for salespeople_item_data in self.salespeople:
                salespeople_item = salespeople_item_data.to_dict()
                salespeople.append(salespeople_item)
        ...
        if salespeople is not UNSET:
            field_dict["salespeople"] = salespeople
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_revenue_change_pct(data: object) -> float | None | str | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        _salespeople = d.pop("salespeople", UNSET)
        salespeople: list[AnalyticsPerformanceEntry] | Unset = UNSET
        if _salespeople is not UNSET:
            salespeople = []
            for salespeople_item_data in _salespeople:
                salespeople_item = AnalyticsPerformanceEntry.from_dict(
                    salespeople_item_data
                )
        ...
        if _customers is not UNSET:
            ...
            for customers_item_data in _customers:
                customers_item = AnalyticsPerformanceEntry.from_dict(
                    customers_item_data
                )
        ...
        if _products is not UNSET:
            ...
            for products_item_data in _products:
                products_item = AnalyticsPerformanceEntry.from_dict(products_item_data)

                products.append(products_item)

        analytics_sales_performance = cls(
            total_revenue=total_revenue,
            deals_won=deals_won,
            deals_lost=deals_lost,
            win_rate=win_rate,
        ...
        analytics_sales_performance.additional_properties = d
        return analytics_sales_performance
