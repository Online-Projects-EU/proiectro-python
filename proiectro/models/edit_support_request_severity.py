...
T = TypeVar("T", bound="EditSupportRequestSeverity")


@_attrs_define
class EditSupportRequestSeverity:
    """Input schema for editing a support request severity
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        edit_support_request_severity = cls(
            name=name,
            internal=internal,
            active=active,
        ...
        edit_support_request_severity.additional_properties = d
        return edit_support_request_severity
