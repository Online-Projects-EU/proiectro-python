...
T = TypeVar("T", bound="AssignedInternalClosedSupportRequestFilterSchema")


@_attrs_define
class AssignedInternalClosedSupportRequestFilterSchema:
    """Filter schema for 'Assigned To Me - Closed Internal Support Requests' page.

    Inherits all fields and behavior from AssignedInternalSupportRequestFilterSchema,
    but overrides the status option loader to show only closed statuses.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        assigned_internal_closed_support_request_filter_schema = cls(
        ...
        assigned_internal_closed_support_request_filter_schema.additional_properties = d
        return assigned_internal_closed_support_request_filter_schema
