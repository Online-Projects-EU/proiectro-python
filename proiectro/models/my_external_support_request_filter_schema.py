...
T = TypeVar("T", bound="MyExternalSupportRequestFilterSchema")


@_attrs_define
class MyExternalSupportRequestFilterSchema:
    """Filter schema for 'My External Support Requests' page.

    Allows users to filter their own submitted external support requests.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        my_external_support_request_filter_schema = cls(
        ...
        my_external_support_request_filter_schema.additional_properties = d
        return my_external_support_request_filter_schema
