...
T = TypeVar("T", bound="EditProductLifecycleStage")


@_attrs_define
class EditProductLifecycleStage:
    """
    Attributes:
        sequence_no (int):
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        edit_product_lifecycle_stage = cls(
            sequence_no=sequence_no,
            name=name,
            lifecycle_type=lifecycle_type,
        ...
        edit_product_lifecycle_stage.additional_properties = d
        return edit_product_lifecycle_stage
