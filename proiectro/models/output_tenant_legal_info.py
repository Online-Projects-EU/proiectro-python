...
T = TypeVar("T", bound="OutputTenantLegalInfo")


@_attrs_define
class OutputTenantLegalInfo:
    """Output schema for tenant legal information (GET endpoint).
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        output_tenant_legal_info.additional_properties = d
        return output_tenant_legal_info
