...
if TYPE_CHECKING:
    from ..models.partner_portal_payment_item import PartnerPortalPaymentItem


T = TypeVar("T", bound="PartnerPortalPayments")


@_attrs_define
class PartnerPortalPayments:
    """Partner's payments visible through bridge

    Attributes:
        bridge_id (str):
        partner_tenant_name (str):
        payments (list[PartnerPortalPaymentItem]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for payments_item_data in _payments:
            payments_item = PartnerPortalPaymentItem.from_dict(payments_item_data)
        ...
        partner_portal_payments.additional_properties = d
        return partner_portal_payments
