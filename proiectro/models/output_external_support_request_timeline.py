...
if TYPE_CHECKING:
    from ..models.output_external_support_request_timeline_replies_map import (
...
T = TypeVar("T", bound="OutputExternalSupportRequestTimeline")


@_attrs_define
class OutputExternalSupportRequestTimeline:
    """Output schema for external support request timeline

    Attributes:
        events (list[SupportRequestTimelineEvent]):
        event_count (int):
        support_request_id (str):
        replies_map (OutputExternalSupportRequestTimelineRepliesMap | Unset):
    ...
    event_count: int
    support_request_id: str
    replies_map: OutputExternalSupportRequestTimelineRepliesMap | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_replies_map, Unset):
            ...
            replies_map = OutputExternalSupportRequestTimelineRepliesMap.from_dict(
                _replies_map
            )

        status_lifecycle = d.pop("status_lifecycle", UNSET)

        output_external_support_request_timeline = cls(
            events=events,
            event_count=event_count,
            support_request_id=support_request_id,
        ...
        output_external_support_request_timeline.additional_properties = d
        return output_external_support_request_timeline
