...
T = TypeVar("T", bound="InternalClosedSupportRequestQueueFilterSchema")


@_attrs_define
class InternalClosedSupportRequestQueueFilterSchema:
    """Filter schema for internal closed support request queue pages.

    Inherits all fields and behavior from InternalSupportRequestQueueFilterSchema,
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        internal_closed_support_request_queue_filter_schema = cls(
        ...
        internal_closed_support_request_queue_filter_schema.additional_properties = d
        return internal_closed_support_request_queue_filter_schema
