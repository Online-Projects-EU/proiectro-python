...
T = TypeVar("T", bound="OutputCampaignProgress")


@_attrs_define
class OutputCampaignProgress:
    """Detailed progress on a specific campaign.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        output_campaign_progress.additional_properties = d
        return output_campaign_progress
