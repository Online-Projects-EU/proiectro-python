...
T = TypeVar("T", bound="ExternalSupportRequestQueueFilterSchema")


@_attrs_define
class ExternalSupportRequestQueueFilterSchema:
    """Filter schema for external support request queue pages (active only).
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        external_support_request_queue_filter_schema = cls(
        ...
        external_support_request_queue_filter_schema.additional_properties = d
        return external_support_request_queue_filter_schema
