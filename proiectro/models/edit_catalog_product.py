...
from ..models.edit_catalog_product_pricing_type import EditCatalogProductPricingType
from ..models.edit_catalog_product_product_type import EditCatalogProductProductType
from ..types import UNSET, Unset

T = TypeVar("T", bound="EditCatalogProduct")


@_attrs_define
class EditCatalogProduct:
    """
    Attributes:
        name (str):
        description_for_customer (str):
        product_type (EditCatalogProductProductType):
        default_lifecycle (str):
        pricing_type (EditCatalogProductPricingType):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        product_type = EditCatalogProductProductType(d.pop("product_type"))

        default_lifecycle = d.pop("default_lifecycle")

        pricing_type = EditCatalogProductPricingType(d.pop("pricing_type"))
        ...
        edit_catalog_product.additional_properties = d
        return edit_catalog_product
