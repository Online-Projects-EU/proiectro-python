...
T = TypeVar("T", bound="OrgFilterSchema")


@_attrs_define
class OrgFilterSchema:
    """Filter schema for organizations (sub-tenants) with comprehensive search and attribute filtering.
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        path_name: None | str | Unset
        if isinstance(self.path_name, Unset):
            path_name = UNSET
        else:
        ...
        my_orgs: bool | None | Unset
        if isinstance(self.my_orgs, Unset):
            my_orgs = UNSET
        else:
            my_orgs = self.my_orgs
        ...
        if path_name is not UNSET:
            field_dict["path_name"] = path_name
        if is_active is not UNSET:
            field_dict["is_active"] = is_active
        if my_orgs is not UNSET:
            field_dict["my_orgs"] = my_orgs
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_path_name(data: object) -> None | str | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        path_name = _parse_path_name(d.pop("path_name", UNSET))
        ...
        def _parse_my_orgs(data: object) -> bool | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        my_orgs = _parse_my_orgs(d.pop("my_orgs", UNSET))
        ...
        org_filter_schema.additional_properties = d
        return org_filter_schema
