...
T = TypeVar("T", bound="ProductWorkTemplates")


@_attrs_define
class ProductWorkTemplates:
    """Work item templates linked to a specific catalog product
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        product_work_templates = cls(
            product_id=product_id,
            product_name=product_name,
            work_templates=work_templates,
        )

        product_work_templates.additional_properties = d
        return product_work_templates
