...
T = TypeVar("T", bound="EditSupportRequestType")


@_attrs_define
class EditSupportRequestType:
    """Input schema for editing a support request type
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        edit_support_request_type.additional_properties = d
        return edit_support_request_type
