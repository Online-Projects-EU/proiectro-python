...
T = TypeVar("T", bound="SupportKPIs")


@_attrs_define
class SupportKPIs:
    """Support KPIs - Ticket volume and performance from real data.

    Shows: Open tickets (internal/external), resolution time, first response, success rate.
        ...
        Attributes:
            ...
            avg_first_response_hours (float | str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        volume_status = d.pop("volume_status")
        ...
        def _parse_avg_first_response_hours(data: object) -> float | str:
            return cast(float | str, data)

        avg_first_response_hours = _parse_avg_first_response_hours(
            d.pop("avg_first_response_hours")
        )

        def _parse_success_rate(data: object) -> float | str:
            return cast(float | str, data)
        ...
        support_kp_is.additional_properties = d
        return support_kp_is
