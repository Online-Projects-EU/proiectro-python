...
T = TypeVar("T", bound="MyInternalClosedSupportRequestFilterSchema")


@_attrs_define
class MyInternalClosedSupportRequestFilterSchema:
    """Filter schema for 'My Closed Internal Support Requests' page.

    Inherits all fields and behavior from MyInternalSupportRequestFilterSchema,
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        my_internal_closed_support_request_filter_schema = cls(
        ...
        my_internal_closed_support_request_filter_schema.additional_properties = d
        return my_internal_closed_support_request_filter_schema
