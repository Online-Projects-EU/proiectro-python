...
T = TypeVar("T", bound="OutputWorkItemTemplateTags")


@_attrs_define
class OutputWorkItemTemplateTags:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        output_work_item_template_tags = cls(
            work_item_template=work_item_template,
            tags=tags,
            unassigned_tags=unassigned_tags,
        )

        output_work_item_template_tags.additional_properties = d
        return output_work_item_template_tags
