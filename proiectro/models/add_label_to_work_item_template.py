...
T = TypeVar("T", bound="AddLabelToWorkItemTemplate")


@_attrs_define
class AddLabelToWorkItemTemplate:
    """
    Attributes:
        work_template (str):
        label (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        work_template = d.pop("work_template")
        ...
        add_label_to_work_item_template = cls(
            work_template=work_template,
            label=label,
        ...
        add_label_to_work_item_template.additional_properties = d
        return add_label_to_work_item_template
