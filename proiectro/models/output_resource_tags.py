...
T = TypeVar("T", bound="OutputResourceTags")


@_attrs_define
class OutputResourceTags:
    """
    Attributes:
        resource (str):
        tags (list[OutputTag]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        output_resource_tags = cls(
            resource=resource,
            tags=tags,
            unassigned_tags=unassigned_tags,
        )

        output_resource_tags.additional_properties = d
        return output_resource_tags
