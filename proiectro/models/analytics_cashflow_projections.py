...
if TYPE_CHECKING:
    from ..models.analytics_cashflow_bucket import AnalyticsCashflowBucket
    from ..models.compare_option import CompareOption
    from ..models.horizon_option import HorizonOption


T = TypeVar("T", bound="AnalyticsCashflowProjections")


@_attrs_define
class AnalyticsCashflowProjections:
    """Cash flow projections by fiscal period with adaptive granularity
    ...
    Attributes:
        ...
        granularity (str | Unset):  Default: 'quarter'.
        buckets (list[AnalyticsCashflowBucket] | Unset):
        quarters (list[AnalyticsCashflowBucket] | Unset):
    """
    ...
    granularity: str | Unset = "quarter"
    buckets: list[AnalyticsCashflowBucket] | Unset = UNSET
    quarters: list[AnalyticsCashflowBucket] | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        quarters: list[dict[str, Any]] | Unset = UNSET
        if not isinstance(self.quarters, Unset):
            quarters = []
            for quarters_item_data in self.quarters:
                quarters_item = quarters_item_data.to_dict()
                quarters.append(quarters_item)
        ...
        if quarters is not UNSET:
            field_dict["quarters"] = quarters
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _buckets is not UNSET:
            ...
            for buckets_item_data in _buckets:
                buckets_item = AnalyticsCashflowBucket.from_dict(buckets_item_data)

                buckets.append(buckets_item)

        _quarters = d.pop("quarters", UNSET)
        quarters: list[AnalyticsCashflowBucket] | Unset = UNSET
        if _quarters is not UNSET:
            quarters = []
            for quarters_item_data in _quarters:
                quarters_item = AnalyticsCashflowBucket.from_dict(quarters_item_data)

                quarters.append(quarters_item)

        analytics_cashflow_projections = cls(
            fiscal_year=fiscal_year,
            currency=currency,
            period=period,
        ...
        analytics_cashflow_projections.additional_properties = d
        return analytics_cashflow_projections
