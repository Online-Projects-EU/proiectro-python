...
T = TypeVar("T", bound="ExternalClosedSupportRequestQueueFilterSchema")


@_attrs_define
class ExternalClosedSupportRequestQueueFilterSchema:
    """Filter schema for external closed support request queue pages.

    Inherits all fields and behavior from ExternalSupportRequestQueueFilterSchema,
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        external_closed_support_request_queue_filter_schema = cls(
        ...
        external_closed_support_request_queue_filter_schema.additional_properties = d
        return external_closed_support_request_queue_filter_schema
