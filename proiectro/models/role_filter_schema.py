...
T = TypeVar("T", bound="RoleFilterSchema")


@_attrs_define
class RoleFilterSchema:
    """Filter schema for roles with comprehensive search and attribute filtering.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        role_filter_schema.additional_properties = d
        return role_filter_schema
