...
T = TypeVar("T", bound="WorkItemNodeChildren")


@_attrs_define
class WorkItemNodeChildren:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        work_item_node_children.additional_properties = additional_properties
        return work_item_node_children
