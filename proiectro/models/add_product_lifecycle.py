...
T = TypeVar("T", bound="AddProductLifecycle")


@_attrs_define
class AddProductLifecycle:
    """
    Attributes:
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        add_product_lifecycle.additional_properties = d
        return add_product_lifecycle
