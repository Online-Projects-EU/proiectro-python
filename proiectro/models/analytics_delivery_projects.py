...
if TYPE_CHECKING:
    from ..models.analytics_project_remaining_item import AnalyticsProjectRemainingItem
    from ..models.compare_option import CompareOption
    from ..models.horizon_option import HorizonOption


T = TypeVar("T", bound="AnalyticsDeliveryProjects")


@_attrs_define
class AnalyticsDeliveryProjects:
    ...
    Attributes:
        ...
        most_remaining_project (None | str | Unset):
        projects (list[AnalyticsProjectRemainingItem] | Unset):
    """
    ...
    most_remaining_project: None | str | Unset = UNSET
    projects: list[AnalyticsProjectRemainingItem] | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        most_remaining_project: None | str | Unset
        if isinstance(self.most_remaining_project, Unset):
            most_remaining_project = UNSET
        else:
            most_remaining_project = self.most_remaining_project
        ...
        if most_remaining_project is not UNSET:
            field_dict["most_remaining_project"] = most_remaining_project
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.analytics_project_remaining_item import (
        ...
        def _parse_most_remaining_project(data: object) -> None | str | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        most_remaining_project = _parse_most_remaining_project(
            d.pop("most_remaining_project", UNSET)
        )
        ...
        if _projects is not UNSET:
            ...
            for projects_item_data in _projects:
                projects_item = AnalyticsProjectRemainingItem.from_dict(
                    projects_item_data
                )

                projects.append(projects_item)

        analytics_delivery_projects = cls(
            total_projects=total_projects,
            total_remaining_hours=total_remaining_hours,
            period=period,
            ...
            most_remaining_project=most_remaining_project,
            projects=projects,
        )

        analytics_delivery_projects.additional_properties = d
        return analytics_delivery_projects
