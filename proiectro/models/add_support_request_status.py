...
from ..models.add_support_request_status_lifecycle import (
    AddSupportRequestStatusLifecycle,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="AddSupportRequestStatus")


@_attrs_define
class AddSupportRequestStatus:
    """Input schema for adding a support request status

    Attributes:
        name (str):
        lifecycle (AddSupportRequestStatusLifecycle | Unset):  Default: AddSupportRequestStatusLifecycle.NEW.
    ...
    name: str
    lifecycle: AddSupportRequestStatusLifecycle | Unset = (
        AddSupportRequestStatusLifecycle.NEW
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_lifecycle, Unset):
            ...
            lifecycle = AddSupportRequestStatusLifecycle(_lifecycle)
        ...
        add_support_request_status = cls(
            name=name,
            lifecycle=lifecycle,
            internal=internal,
            active=active,
        ...
        add_support_request_status.additional_properties = d
        return add_support_request_status
