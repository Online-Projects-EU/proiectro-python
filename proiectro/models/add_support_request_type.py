...
T = TypeVar("T", bound="AddSupportRequestType")


@_attrs_define
class AddSupportRequestType:
    """Input schema for adding a support request type
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        add_support_request_type.additional_properties = d
        return add_support_request_type
