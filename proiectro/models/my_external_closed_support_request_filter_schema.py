...
T = TypeVar("T", bound="MyExternalClosedSupportRequestFilterSchema")


@_attrs_define
class MyExternalClosedSupportRequestFilterSchema:
    """Filter schema for 'My Closed External Support Requests' page.

    Inherits all fields and behavior from MyExternalSupportRequestFilterSchema,
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        my_external_closed_support_request_filter_schema = cls(
        ...
        my_external_closed_support_request_filter_schema.additional_properties = d
        return my_external_closed_support_request_filter_schema
