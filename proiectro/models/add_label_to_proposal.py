...
T = TypeVar("T", bound="AddLabelToProposal")


@_attrs_define
class AddLabelToProposal:
    """
    Attributes:
        proposal (str):
        label (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        add_label_to_proposal.additional_properties = d
        return add_label_to_proposal
