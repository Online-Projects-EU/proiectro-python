...
T = TypeVar("T", bound="AddLabelToWorkItem")


@_attrs_define
class AddLabelToWorkItem:
    """
    Attributes:
        work_item (str):
        label (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        add_label_to_work_item.additional_properties = d
        return add_label_to_work_item
