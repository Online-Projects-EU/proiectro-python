...
T = TypeVar("T", bound="AssignedExternalClosedSupportRequestFilterSchema")


@_attrs_define
class AssignedExternalClosedSupportRequestFilterSchema:
    """Filter schema for 'Assigned To Me - Closed External Support Requests' page.

    Inherits all fields and behavior from AssignedExternalSupportRequestFilterSchema,
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        assigned_external_closed_support_request_filter_schema = cls(
        ...
        assigned_external_closed_support_request_filter_schema.additional_properties = d
        return assigned_external_closed_support_request_filter_schema
