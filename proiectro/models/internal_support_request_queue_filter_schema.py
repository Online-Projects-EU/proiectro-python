...
T = TypeVar("T", bound="InternalSupportRequestQueueFilterSchema")


@_attrs_define
class InternalSupportRequestQueueFilterSchema:
    """Filter schema for internal support request queue pages (active only).
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        internal_support_request_queue_filter_schema = cls(
        ...
        internal_support_request_queue_filter_schema.additional_properties = d
        return internal_support_request_queue_filter_schema
