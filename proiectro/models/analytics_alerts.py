...
if TYPE_CHECKING:
    from ..models.analytics_alert_item import AnalyticsAlertItem
    from ..models.compare_option import CompareOption
    from ..models.horizon_option import HorizonOption


T = TypeVar("T", bound="AnalyticsAlerts")


@_attrs_define
class AnalyticsAlerts:
    """Business alerts for Command Center
    ...
    Attributes:
        ...
        alerts (list[AnalyticsAlertItem] | Unset):
    """
    ...
    alerts: list[AnalyticsAlertItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _alerts is not UNSET:
            ...
            for alerts_item_data in _alerts:
                alerts_item = AnalyticsAlertItem.from_dict(alerts_item_data)

                alerts.append(alerts_item)

        analytics_alerts = cls(
            critical_count=critical_count,
            warning_count=warning_count,
            info_count=info_count,
            period=period,
        ...
        analytics_alerts.additional_properties = d
